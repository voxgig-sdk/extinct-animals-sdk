...
function runner.env_override(m)
  local live = runner.getenv("EXTINCTANIMALS_TEST_LIVE")
  local override = runner.getenv("EXTINCTANIMALS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("EXTINCTANIMALS_TEST_EXPLAIN")
