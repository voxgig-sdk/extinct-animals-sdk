...
function runner.env_override(m)
  local live = runner.getenv("EXTINCT_ANIMALS_TEST_LIVE")
  local override = runner.getenv("EXTINCT_ANIMALS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("EXTINCT_ANIMALS_TEST_EXPLAIN")
