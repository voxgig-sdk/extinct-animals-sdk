...
// ExtinctAnimals SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ExtinctAnimalsSDK::test)
...
{
    private const SDK_CLASS = 'ExtinctAnimalsSDK';
    ...
    private const SDK_BASE = 'extinctanimals_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../extinctanimals_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
