...
// ExtinctAnimals SDK proxy feature
...
class ExtinctAnimalsProxyFeature extends ExtinctAnimalsBaseFeature
{
    ...
    public function init(ExtinctAnimalsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ExtinctAnimalsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
