...
// ExtinctAnimals SDK clienttrack feature
...
class ExtinctAnimalsClienttrackFeature extends ExtinctAnimalsBaseFeature
{
    ...
    public function PostConstruct(ExtinctAnimalsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ExtinctAnimals-SDK';
