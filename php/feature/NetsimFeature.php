...
// ExtinctAnimals SDK netsim feature
...
class ExtinctAnimalsNetsimFeature extends ExtinctAnimalsBaseFeature
{
    ...
    private function _simulate(ExtinctAnimalsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ExtinctAnimalsContext $ctx, array $applied): void
    {
        $client = $this->client;
