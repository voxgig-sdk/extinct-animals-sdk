...
// ExtinctAnimals SDK debug feature
...
class ExtinctAnimalsDebugFeature extends ExtinctAnimalsBaseFeature
{
    ...
    private function _finish(ExtinctAnimalsContext $ctx, bool $ok): void
    {
