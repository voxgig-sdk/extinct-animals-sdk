...
// ExtinctAnimals SDK cache feature
...
class ExtinctAnimalsCacheFeature extends ExtinctAnimalsBaseFeature
{
    ...
    private function _through(ExtinctAnimalsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
