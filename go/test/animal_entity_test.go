...
func TestAnimalEntity(t *testing.T) {
	...
	t.Run("stream", func(t *testing.T) {
		...
		var seen []any
		for item := range base.Animal(nil).Stream("list", nil, nil) {
		...
		if hasStreaming {
			...
			var got []any
			for item := range streamSdk.Animal(nil).Stream("list", nil, nil) {
...
func animalBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("EXTINCT_ANIMALS_TEST_ANIMAL_ENTID")
	...
	idmapResolved := core.ToMapAny(env["EXTINCT_ANIMALS_TEST_ANIMAL_ENTID"])
