...
// instead of `sdk.NewExtinctAnimalsSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *ExtinctAnimalsSDK  { return NewExtinctAnimalsSDK(nil) }
func Test() *ExtinctAnimalsSDK { return TestSDK(nil, nil) }
