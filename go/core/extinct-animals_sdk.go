...
func (sdk *ExtinctAnimalsSDK) OptionsMap() map[string]any {
...
func (sdk *ExtinctAnimalsSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ExtinctAnimalsSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ExtinctAnimalsSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ExtinctAnimalsSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ExtinctAnimalsSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ExtinctAnimalsSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ExtinctAnimalsSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ExtinctAnimalsSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ExtinctAnimalsSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ExtinctAnimalsSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *ExtinctAnimalsSDK {
	...
	sdk := NewExtinctAnimalsSDK(sdkopts)
	sdk.Mode = "test"
