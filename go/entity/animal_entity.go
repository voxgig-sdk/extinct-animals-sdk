...
func NewAnimalEntity(client *core.ExtinctAnimalsSDK, entopts map[string]any) *AnimalEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AnimalEntity) GetName() string { return e.name }
...
func (e *AnimalEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AnimalEntity) Deleted() bool {
	return e.deleted
}


func (e *AnimalEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAnimalEntity(e.client, opts)
}

func (e *AnimalEntity) Data(args ...any) any {
...
func (e *AnimalEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *AnimalEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AnimalEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *AnimalEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AnimalEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AnimalEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AnimalEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
