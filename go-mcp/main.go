// Command ExtinctAnimals-mcp is an MCP server exposing the ExtinctAnimals
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ExtinctAnimals_list  — list records of an entity
//	ExtinctAnimals_load  — load a single record of an entity
//
