...
type Args struct {
	Entity string         `json:"entity" jsonschema:"animal"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ExtinctAnimalsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "extinct-animals_list",
		Description: "List records from ExtinctAnimals. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "extinct-animals_load",
		Description: "Load a single record from ExtinctAnimals. " +
...
func runOp(client *sdk.ExtinctAnimalsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ExtinctAnimalsSDK, name string) (sdk.ExtinctAnimalsEntity, error) {
	switch strings.ToLower(name) {
	case "animal":
		return client.Animal(nil), nil
