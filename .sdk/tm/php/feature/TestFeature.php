...
// ExtinctAnimals SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ExtinctAnimalsTestFeature extends ExtinctAnimalsBaseFeature
{
    ...
    public function init(ExtinctAnimalsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ExtinctAnimalsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = ExtinctAnimalsParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ExtinctAnimalsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ExtinctAnimalsContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = ExtinctAnimalsParam::call($ctx, $k);
