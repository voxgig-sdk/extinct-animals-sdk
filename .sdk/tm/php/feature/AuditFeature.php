...
// ExtinctAnimals SDK audit feature
...
class ExtinctAnimalsAuditFeature extends ExtinctAnimalsBaseFeature
{
    ...
    private function _emit(ExtinctAnimalsContext $ctx, string $outcome): void
    {
