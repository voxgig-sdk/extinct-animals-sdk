...
// ExtinctAnimals SDK ratelimit feature
...
class ExtinctAnimalsRatelimitFeature extends ExtinctAnimalsBaseFeature
{
    ...
    private function _acquire(ExtinctAnimalsContext $ctx): void
    {
    ...
    private function _track(ExtinctAnimalsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
