...
// ExtinctAnimals SDK timeout feature
...
class ExtinctAnimalsTimeoutFeature extends ExtinctAnimalsBaseFeature
{
    ...
    private function _with_timeout(ExtinctAnimalsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ExtinctAnimalsContext $_ctx, float $ms): void
    {
        $client = $this->client;
