...
// ExtinctAnimals SDK rbac feature
...
class ExtinctAnimalsRbacFeature extends ExtinctAnimalsBaseFeature
{
    ...
    private function _required(ExtinctAnimalsContext $ctx): ?string
    {
    ...
    private function _reject(ExtinctAnimalsContext $ctx, string $required): void
    {
    ...
    private function _track(ExtinctAnimalsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
