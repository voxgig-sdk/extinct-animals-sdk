...
// ExtinctAnimals SDK pipeline test
//
...
{
    private static function utility(): ExtinctAnimalsUtility
    {
        return new ExtinctAnimalsUtility();
    }
    ...
    private static function ctx(array $over = []): ExtinctAnimalsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ExtinctAnimalsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ExtinctAnimalsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ExtinctAnimalsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ExtinctAnimalsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ExtinctAnimalsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ExtinctAnimalsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ExtinctAnimalsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ExtinctAnimalsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ExtinctAnimalsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ExtinctAnimalsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ExtinctAnimalsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ExtinctAnimalsResponse([]),
            'result' => new ExtinctAnimalsResult([]),
        ]);
        [, $err] = ExtinctAnimalsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ExtinctAnimalsSpec([]),
            'response' => null,
            'result' => new ExtinctAnimalsResult([]),
        ]);
        [, $err] = ExtinctAnimalsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ExtinctAnimalsSpec(['step' => 's']),
            'response' => new ExtinctAnimalsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ExtinctAnimalsResult([]),
        ]);
        [, $err] = ExtinctAnimalsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ExtinctAnimalsSpec(['step' => 's']),
            'response' => new ExtinctAnimalsResponse(self::resp(200, ['v' => 1])),
            'result' => new ExtinctAnimalsResult([]),
        ]);
        [, $err] = ExtinctAnimalsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ExtinctAnimalsSpec(['step' => 's']),
            'response' => new ExtinctAnimalsResponse(self::resp(200, ['v' => 2])),
            'result' => new ExtinctAnimalsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ExtinctAnimalsMakeResponse::call($ctx);
    ...
    {
        $preset = new ExtinctAnimalsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ExtinctAnimalsSpec([]),
            'response' => new ExtinctAnimalsResponse([]),
            'result' => new ExtinctAnimalsResult([]),
        ...
        [$got, $err] = ExtinctAnimalsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ExtinctAnimalsResult([])]);
        [, $err] = ExtinctAnimalsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ExtinctAnimalsSpec([]), 'result' => null]);
        [, $err] = ExtinctAnimalsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ExtinctAnimalsSpec(['step' => 's']),
            'result' => new ExtinctAnimalsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ExtinctAnimalsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ExtinctAnimalsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ExtinctAnimalsSpec(['step' => 's']),
            'result' => new ExtinctAnimalsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ExtinctAnimalsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ExtinctAnimalsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ExtinctAnimalsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ExtinctAnimalsSpec([]),
            'result' => new ExtinctAnimalsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ExtinctAnimalsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ExtinctAnimalsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ExtinctAnimalsError('boom', 'boom');
        $utility->fetcher = function (ExtinctAnimalsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ExtinctAnimalsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ExtinctAnimalsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ExtinctAnimalsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ExtinctAnimalsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ExtinctAnimalsResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        ExtinctAnimalsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ExtinctAnimalsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ExtinctAnimalsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ExtinctAnimalsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ExtinctAnimalsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ExtinctAnimalsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ExtinctAnimalsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ExtinctAnimalsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ExtinctAnimalsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ExtinctAnimalsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ExtinctAnimalsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ExtinctAnimalsResult(['ok' => false])]);
        $this->expectException(ExtinctAnimalsError::class);
        ExtinctAnimalsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ExtinctAnimalsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ExtinctAnimalsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ExtinctAnimalsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ExtinctAnimalsBaseFeature();
        $b = new ExtinctAnimalsBaseFeature();
        ExtinctAnimalsFeatureAdd::call($ctx, $a);
        ExtinctAnimalsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ExtinctAnimalsBaseFeature
    {
        $f = new ExtinctAnimalsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ExtinctAnimalsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ExtinctAnimalsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ExtinctAnimalsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ExtinctAnimalsPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        ExtinctAnimalsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ExtinctAnimalsResponse(['headers' => null]),
            'result' => new ExtinctAnimalsResult([]),
        ]);
        ExtinctAnimalsResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        ExtinctAnimalsResultBody::call($ctx);
