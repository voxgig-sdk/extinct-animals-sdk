...
// ExtinctAnimals SDK utility type

class ExtinctAnimalsUtility
{
    ...
    public static function copy(ExtinctAnimalsUtility $src): ExtinctAnimalsUtility
    {
        $u = new ExtinctAnimalsUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
