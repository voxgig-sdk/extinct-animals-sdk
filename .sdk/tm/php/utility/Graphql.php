...
// ExtinctAnimals SDK utility: graphql
//
...
class ExtinctAnimalsGraphql
{
    ...
    // equivalent.
    public static function body(ExtinctAnimalsContext $ctx): mixed
    {
    ...
    public static function errors(ExtinctAnimalsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
