...
// ExtinctAnimals SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ExtinctAnimalsMakeRequest
{
    public static function call(ExtinctAnimalsContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ExtinctAnimalsResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ExtinctAnimalsResponse($fetched);
        } else {
