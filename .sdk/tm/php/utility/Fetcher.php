...
// ExtinctAnimals SDK utility: fetcher

class ExtinctAnimalsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ExtinctAnimalsSDK/1.0)';
    ...
    public static function call(ExtinctAnimalsContext $ctx, string $fullurl, array $fetchdef): array
    {
