...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/extinct-animals` | `npm install @voxgig-sdk/extinct-animals` |
| Python | `voxgig-sdk-extinct-animals` | `pip install voxgig-sdk-extinct-animals` |
| PHP | `voxgig-sdk/extinct-animals` | `composer require voxgig-sdk/extinct-animals` |
| Golang | `github.com/voxgig-sdk/extinct-animals-sdk/go` | `go get github.com/voxgig-sdk/extinct-animals-sdk/go` |
| Ruby | `voxgig-sdk-extinct-animals` | `gem install voxgig-sdk-extinct-animals` |
| Lua | `voxgig-sdk-extinct-animals` | `luarocks install voxgig-sdk-extinct-animals` |
