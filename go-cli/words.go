...
func registerSDKWords(r *eng.Registry, client *sdk.ExtinctAnimalsSDK) {
...
func runOp(client *sdk.ExtinctAnimalsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
