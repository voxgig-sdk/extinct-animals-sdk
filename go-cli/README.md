...
AQL-driven CLI and REPL for the ExtinctAnimals SDK. Positional arguments are
...
```sh
go build -o extinct-animals-cli ./...
```
...
./extinct-animals-cli load 1 animal
./extinct-animals-cli load '{id:1}' animal
