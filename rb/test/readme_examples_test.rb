...
#      offline in seeded test mode (ExtinctAnimalsSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ExtinctAnimals_sdk.rb")
  SDK_CLASS = "ExtinctAnimalsSDK"
