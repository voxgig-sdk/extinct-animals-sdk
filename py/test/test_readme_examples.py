# ExtinctAnimals SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ExtinctAnimalsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ExtinctAnimalsSDK(...) and ExtinctAnimalsSDK.test(...) become
#      ExtinctAnimalsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "extinctanimals_sdk"
_SDK_CLASS = "ExtinctAnimalsSDK"
