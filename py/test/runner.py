...
class ExtinctAnimalsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ExtinctAnimalsTestRunner.getenv("EXTINCTANIMALS_TEST_LIVE")
        override = ExtinctAnimalsTestRunner.getenv("EXTINCTANIMALS_TEST_OVERRIDE")
        ...
        explain = ExtinctAnimalsTestRunner.getenv("EXTINCTANIMALS_TEST_EXPLAIN")
