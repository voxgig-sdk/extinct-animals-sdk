...
from extinctanimals_sdk.core.control import ExtinctAnimalsControl
...
from extinctanimals_sdk.core.helpers import get_ctx_prop, to_map
...
class ExtinctAnimalsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = ExtinctAnimalsControl()
        ...
        if isinstance(sp, ExtinctAnimalsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ExtinctAnimalsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ExtinctAnimalsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return ExtinctAnimalsOperation({})
    ...
    def make_error(self, code, msg):
        return ExtinctAnimalsError(code, msg, self)
