...
from extinctanimals_sdk.utility import register

# Load features
from extinctanimals_sdk.feature.base_feature import ExtinctAnimalsBaseFeature
from extinctanimals_sdk.features import _make_feature
...
class ExtinctAnimalsSDK:
    ...
    def get_utility(self):
        return ExtinctAnimalsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ExtinctAnimalsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Animal(self, data=None) -> "AnimalEntity":
        ...
        from extinctanimals_sdk.entity.animal_entity import AnimalEntity
