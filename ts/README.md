...
| `tester(testopts?, sdkopts?)` | `ExtinctAnimalsSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `ExtinctAnimalsSDK.test(testopts?, sdkopts?)` | `ExtinctAnimalsSDK` | Create a test-mode client. |
...
extinct-animals/
├── src/
│   ├── ExtinctAnimalsSDK.ts        # Main SDK class
