...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.EXTINCT_ANIMALS_TEST_LIVE ||
    'TRUE' === process.env.EXTINCT_ANIMALS_TEST_OVERRIDE
  ) {
  ...
  m.EXTINCT_ANIMALS_TEST_EXPLAIN = process.env.EXTINCT_ANIMALS_TEST_EXPLAIN || m.EXTINCT_ANIMALS_TEST_EXPLAIN
